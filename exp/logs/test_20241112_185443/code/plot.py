...
def compare_pref_with_policy(env: LinearBandit,ret_action_prob, dataset: List[Transition]) -> float:
        """
        ...
        for transition in dataset:
            ...
            action_one_idx = env.actions.index(action_one)
            action_two_idx = env.actions.index(action_two)
